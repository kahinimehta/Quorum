...
| **Step 3** | **Grant Proposal (CUA)** — bundled `graded6` NIH R01 demo (hypothesis, aims, full HTML report in iframe); separate from Step 2 formula rankings. Live runs: `python -m cua.nih.run_db` (see [Conclusion Update](workflow/conclusion-update#cua-package-optional--nih-grant-proposal)) |
