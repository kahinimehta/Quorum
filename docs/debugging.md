...
- [ ] **Step 2** — **Pipeline complete** badge, three output panels (ideal candidate profiles · scrollable ranked outputs · hypotheses); **Audit & provenance** collapsed until you expand it for agent trace
