...
- [ ] **Step 2** — **Pipeline complete** badge, three output panels (profiles · ranked outputs match hypotheses height, scroll when longer · hypotheses); **Audit & provenance** collapsed until you expand it for agent trace
