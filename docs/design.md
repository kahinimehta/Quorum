...
- **Three-tab navigation** — Step 1 configure & run · Step 2 discovery results · Step 3 static grant proposal (`graded6`, last tab; proposal expanded at top, one **Pipeline trace & audit** collapse for all supporting sections, **Jump to** nav)
