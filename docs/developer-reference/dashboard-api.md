...
| **Step 3** | Static CUA grant proposal — bundled `graded6` demo inlined (not run-scoped); Proposal section first; pipeline/writer/booster/audit in collapsed category groups; jump-to opens Proposal or category |
