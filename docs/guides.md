...
Dashboard **Step 3** shows a **static** bundled demo (`graded6`) with hero KPIs, audit status chips, jump-to nav, and an inlined report. To generate a new proposal from your DB:
