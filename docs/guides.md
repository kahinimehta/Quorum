...
Dashboard **Step 3** shows a **static** bundled demo (`graded6`) with hero KPIs, audit status chips, jump-to nav (Proposal + four categories), and an inlined report with the **NIH proposal first** and pipeline/writer/booster/audit grouped below. To generate a new proposal from your DB:
