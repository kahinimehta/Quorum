...
- **Dual Agent 6:** orchestrator formula rankings in the pipeline; optional **`cua/`** NIH proposal on dashboard Step 3 (static `graded6` demo — proposal first, nested supporting-details group)  
