...
3. **Step 2 — Discovery Results** — synthetic cohort, ranked treatments, hypotheses (scores from **this run’s** recommendations); **Audit & provenance** collapsed by default — expand for agent trace + evidence table.
